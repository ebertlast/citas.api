...
BEGIN
	...
	SET @SQL = 'SELECT top 10 CIT.*,DBO.FNK_CapitalizarTexto(MED.NOMBRE) Medico,FECHAESCRITA=CONVERT(VARCHAR,GETDATE(),103)+'' ''+CONVERT(VARCHAR,GETDATE(),108) FROM CIT LEFT JOIN MED ON MED.IDMEDICO=CIT.IDMEDICO WHERE 1=1 '
